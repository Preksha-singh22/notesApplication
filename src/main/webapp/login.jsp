...
<!-- <meta name="keywords" content="Preksha,Note App,Note Application"> -->
		...
		<c:choose>
			...
			<div class="mdl-card mdl-shadow--6dp">
				...
				<div class="mdl-card__supporting-text">
					...
					<div ng-init="showHideVisbilityIcon='visibility_off'"
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input type="{{inputType}}" ng-model="passwrd" ng-change="checkform()"
							class="pointer-events-auto mdl-textfield__input" id="password"
							pattern=".{4,15}"
							name='passwrd' required> <label
							class="pointer-events-auto mdl-textfield__label" for="password"> <spring:message
